...
export default function Hero({ systemRole, totalBusinesses, totalInvoices }) {
  return (
    <div className="w-full bg-background dark:bg-slate-950 text-foreground flex flex-col overflow-x-hidden" id="home">
      
      {/* ================= HERO SECTION ================= */}
      <section className="relative min-h-[100svh] flex items-center justify-center pt-32 pb-20 overflow-hidden bg-background dark:bg-slate-950">
        ...
        <div className="absolute top-0 inset-x-0 h-40 bg-linear-to-b from-background dark:from-slate-950 to-transparent z-10"></div>
